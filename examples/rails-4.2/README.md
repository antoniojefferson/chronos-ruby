# Rails 4.2 compatibility application
...
```bash
BUNDLE_GEMFILE=examples/rails-4.2/Gemfile bundle _1.17.3_ install
BUNDLE_GEMFILE=examples/rails-4.2/Gemfile bundle _1.17.3_ exec ruby examples/rails-4.2/script/smoke
```
